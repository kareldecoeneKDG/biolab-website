        ...
        <div class="flex-row-desktop">
            <div class="introduction introduction-wif">
                ...
                <?php if ($page->wordFablabText()->isNotEmpty()) : ?>
                    <p class="introduction__p p"><?= $page->wordFablabText() ?></p>
                <?php endif; ?>



                <?php if ($page->synergyFablabTitle()->isNotEmpty()) : ?>
                    <h1 class="introduction__title wif-title h1"><?= $page->synergyFablabTitle() ?></h1>
                <?php endif; ?>

                <?php if ($page->synergyFablabText()->isNotEmpty()) : ?>
                ...
                <?php /*<h1 class="h1-what-is-fablab">
